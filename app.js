...
function modal_088() {
    Swal.fire({
        ...
        //CARPETA 1 
        '<a href="https://drive.google.com/drive/folders/1-0WNMHe2N1aDs1Ivt-_oQBzv8IMBpSQG?usp=share_link" target="_blank">' +
...
function modal_08() {
    Swal.fire({
        html: '<div class="mensaje-2">' +
            ...
            //mediafire jpg
            '<a href="https://drive.google.com/drive/folders/13NQNrOOR0EAyXtvpggsuymUMP_NNLmIc?usp=share_link" target="_blank">'+
...
const enviarFormulario = () => {
    ...
    var win = window.open(`https://wa.me/54${numero}?text=Mis Fotos Cami App Web:%20https://bit.ly/3YYctqS%0APara que el enlace se active me tienes que ajenar`, '_blank');
...
botonWspp.addEventListener('click', function () {
    location.href = "https://wa.me/?text=https://bit.ly/3YYctqS"
});
...
shareBtn.addEventListener('click', event => {
    if (navigator.share) {
        //drive
        navigator.share({
            text: 'Instala la App web "Mis Fotos Cami": ',
            url: 'https://bit.ly/3YYctqS'
        }).then(() => {
            console.log('Gracias por compartir Mis Fotos Cami!');
        })
